...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        .btn { padding: 8px 15px; border: none; border-radius: 4px; color: white; cursor: pointer; display: inline-flex; align-items: center; justify-content: center; gap: 5px; text-decoration: none;}
        .btn-primary { background: #0056b3; } .btn-success { background: #28a745; } .btn-danger { background: #dc3545; } .btn-info { background: #17a2b8; } .btn-secondary { background: #6c757d; }
        
        .table-responsive { width: 100%; overflow-x: auto; -webkit-overflow-scrolling: touch; }
        .table-std { width: 100%; border-collapse: collapse; white-space: nowrap; } 
        ...
        .modal-content { background: white; padding: 20px; width: 90%; max-width: 700px; border-radius: 8px; max-height: 80vh; overflow-y: auto; box-sizing: border-box;}
        ...
        @media (max-width: 768px) {
            ...
            .filters > div[style*="grid-column: span 2;"] { grid-column: span 1 !important; }
            .filters > div[style*="display:flex; gap:5px;"] { flex-direction: column; }
        }
    </style>
    <script>
        ...
        <div class="panel-card">
            ...
            <div class="filters">
                <div style="grid-column: span 2;">
                    <label style="display:block; margin-bottom:5px;">Buscar</label> <asp:TextBox ID="txtBuscar" runat="server" CssClass="input-std" placeholder="N° Factura..."></asp:TextBox>
                </div>
                <div><label style="display:block; margin-bottom:5px;">Estado</label> <asp:DropDownList ID="ddlEstado" runat="server" CssClass="input-std"><asp:ListItem Value="-1">Todos</asp:ListItem><asp:ListItem Value="1">Activo</asp:ListItem><asp:ListItem Value="0">Anulado</asp:ListItem></asp:DropDownList></div>
                <div><label style="display:block; margin-bottom:5px;">Desde</label> <asp:TextBox ID="txtF1" runat="server" TextMode="Date" CssClass="input-std"></asp:TextBox></div>
                <div><label style="display:block; margin-bottom:5px;">Hasta</label> <asp:TextBox ID="txtF2" runat="server" TextMode="Date" CssClass="input-std"></asp:TextBox></div>
